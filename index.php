...
<body>
    <div class="container">
        ...
        <div class="centered">
            <h2>Public Health</h2>
            <p>
                Public health is a field that focuses on improving the health of populations by preventing diseases, promoting healthy behaviors, 
                and ensuring access to healthcare services. It involves a range of activities, from conducting research on the causes and prevention 
                of diseases to developing policies and programs that promote healthy living.
            </p>
            <h2>Healthcare Access</h2>
            <p>
                Healthcare access refers to the ability of individuals to obtain healthcare services when they need them. Access to healthcare services can be affected by a range of factors, including geographic location, income, insurance coverage, and cultural and linguistic barriers. 
